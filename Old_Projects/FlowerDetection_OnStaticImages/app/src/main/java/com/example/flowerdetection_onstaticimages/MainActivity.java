package com.example.flowerdetection_onstaticimages;
...
import com.example.flowerdetection_onstaticimages.ml.Model;
...
public class MainActivity extends AppCompatActivity {
    ...
    String images[]={"daisy.jpg","dandelion.jpg","roses.jpg","sunflower.jpg","tulips.jpg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //test 1
        detection_result.setText("");

        readImages();

        //test 2
        //imageView.setImageBitmap(bitmaps[4]);
    ...
    void setButtonClickListener()
    {
        randomize.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int random_image=(int)  (Math.random()*5);
                System.out.println("*************\n"+random_image+"\n**************");
